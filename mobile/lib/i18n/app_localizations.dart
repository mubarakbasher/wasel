...
class AppLocalizations {
  ...
  static const Map<String, String> _en = {
    ...
    'auth.businessName': 'Network Name',
    ...
    'subscription.monthlyPrice': 'SDG {0}/month',
    'common.currencySymbol': 'SDG',
    ...
    'subscription.feat.routerOne': '1 Router',
    'subscription.feat.routerMany': '{0} Routers',
    'subscription.feat.monitoring.active': 'Active session monitoring',
    'subscription.feat.monitoring.history': 'Session history',
    'subscription.feat.monitoring.full': 'Full session history + export',
    'subscription.feat.dashboard.basic': 'Basic dashboard',
    'subscription.feat.dashboard.advanced': 'Advanced analytics',
    'subscription.feat.dashboard.full': 'Full analytics + reports',
    ...
    'auth.businessNameOptional': 'Network Name (optional)',
    ...
    'routers.setup.step9.title': 'Firewall — allow RADIUS authentication traffic',
    'routers.setup.step9.desc': 'Allows UDP port 1812 from the Wasel VPS so RADIUS authentication packets are not dropped.',
    'routers.setup.step10.title': 'Firewall — allow RADIUS CoA traffic',
    'routers.setup.step10.desc': 'Allows UDP port 3799 from the Wasel VPS so CoA disconnect and policy-push packets are not dropped.',
    'routers.setup.step11.title': 'Firewall — allow WireGuard',
    'routers.setup.step11.desc': 'Allows UDP port 51820 so the WireGuard tunnel can be established even if the default firewall has a drop rule.',
    ...
    'payment.transferInstructions': 'Transfer Instructions',
    'payment.bankNotConfigured': 'Contact admin for bank details',
    ...
    'settings.contactSubtitle': 'Send a message to our team',
    'contact.title': 'Contact Support',
    'contact.empty': 'No messages yet. Send us a message and we\'ll reply here.',
    'contact.composerHint': 'Type a message...',
  ...
  static const Map<String, String> _ar = {
    ...
    'dashboard.vouchersToday': 'كروت اليوم',
    ...
    'dashboard.totalVouchers': 'إجمالي الكروت',
    'dashboard.activeVouchers': 'الكروت النشطة',
    ...
    'routers.totalVouchers': 'إجمالي الكروت',

    // ── Vouchers ──────────────────────────────────────────────────────────────
    'vouchers.title': 'الكروت',
    'vouchers.createVoucher': 'إنشاء كرت',
    'vouchers.bulkCreate': 'إنشاء مجمّع',
    'vouchers.noVouchers': 'لم يتم إنشاء كروت بعد',
    ...
    'vouchers.deleteVoucher': 'حذف الكرت',
    'vouchers.deleteConfirm': 'هل أنت متأكد من حذف هذا الكرت؟ سيتم قطع الجلسات النشطة.',
    'vouchers.selectRouter': 'اختر الراوتر',
    'vouchers.selectProfile': 'اختر الباقة',
    'vouchers.allRouters': 'جميع الراوترات',
    'vouchers.createdSuccessfully': 'تم إنشاء الكرت بنجاح',
    'vouchers.bulkCreatedSuccessfully': 'تم إنشاء {0} كرت بنجاح',
    'vouchers.voucherDetails': 'تفاصيل الكرت',
    ...
    'subscription.voucherQuota': 'حصة الكروت',
    ...
    'subscription.monthlyPrice': 'ج.س {0}/شهر',
    'common.currencySymbol': 'ج.س',
    'subscription.maxRouters': '{0} راوتر',
    'subscription.monthlyVouchers': '{0} كرت/شهر',
    'subscription.unlimitedVouchers': 'كروت غير محدودة',
    'subscription.feat.routerOne': 'راوتر واحد',
    'subscription.feat.routerMany': '{0} راوترات',
    'subscription.feat.monitoring.active': 'مراقبة الجلسات النشطة',
    'subscription.feat.monitoring.history': 'سجل الجلسات',
    'subscription.feat.monitoring.full': 'سجل الجلسات الكامل + تصدير',
    'subscription.feat.dashboard.basic': 'لوحة تحكم أساسية',
    'subscription.feat.dashboard.advanced': 'تحليلات متقدمة',
    'subscription.feat.dashboard.full': 'تحليلات كاملة + تقارير',
    ...
    'profiles.deleteConfirm': 'هل أنت متأكد من حذف هذه الباقة؟ لن تتأثر الكروت المرتبطة بها.',
    'profiles.editProfile': 'تعديل الباقة',
    'profiles.profileDetails': 'تفاصيل الباقة',
    'profiles.groupName': 'اسم المجموعة',
    'profiles.vouchersUsingProfile': '{0} كرت يستخدم هذه الباقة',
    ...
    'auth.businessNameOptional': 'اسم الشبكة (اختياري)',
    'auth.phoneHint': '+1234567890',
    ...
    'routers.setup.step7.desc': 'يوجّه راوترك إلى خادم RADIUS الخاص بـ Wasel لمصادقة الكروت. service=hotspot,login مطلوب في بعض إصدارات RouterOS.',
    'routers.setup.step8.title': 'تفعيل مستمع CoA',
    'routers.setup.step8.desc': 'يتيح لـ Wasel قطع جلسات الكروت ودفع تحديثات السياسة من جانب الخادم.',
    'routers.setup.step9.title': 'جدار الحماية — السماح بحركة مصادقة RADIUS',
    'routers.setup.step9.desc': 'يسمح بمنفذ UDP 1812 من خادم Wasel VPS حتى لا تُحذف حزم مصادقة RADIUS.',
    'routers.setup.step10.title': 'جدار الحماية — السماح بحركة CoA الخاصة بـ RADIUS',
    'routers.setup.step10.desc': 'يسمح بمنفذ UDP 3799 من خادم Wasel VPS حتى لا تُحذف حزم قطع الاتصال وتحديثات السياسة.',
    'routers.setup.step11.title': 'جدار الحماية — السماح بـ WireGuard',
    'routers.setup.step11.desc': 'يسمح بمنفذ UDP 51820 حتى يمكن إنشاء نفق WireGuard حتى لو كان جدار الحماية الافتراضي يحتوي على قاعدة حذف.',
    ...
    'vouchers.searchHint': 'بحث عن رمز الكرت...',
    'vouchers.selectRouterHint': 'اختر راوتر',
    'vouchers.chooseRouterAbove': 'اختر راوتر أعلاه لعرض كروته.',
    'vouchers.noVouchersYet': 'لا توجد كروت بعد',
    'vouchers.createFirst': 'أنشئ أول كرت لهذا الراوتر.',
    'vouchers.deleteTitle': 'حذف الكروت؟',
    'vouchers.deleteCount': 'حذف {0} كرت؟ لا يمكن التراجع عن هذا.',
    'vouchers.vouchersDeleted': 'تم حذف {0} كرت',
    'vouchers.deleteAllTitle': 'حذف كل الكروت؟',
    'vouchers.deleteAllCount2': 'حذف كل {0} كرت؟ لا يمكن التراجع عن هذا.',
    'vouchers.deleteAll': 'حذف الكل',
    'vouchers.noVouchersToPrint': 'لا توجد كروت للطباعة',
    'vouchers.failedToLoad': 'فشل تحميل الكروت',
    'vouchers.voucherCreated': 'تم إنشاء الكرت!',
    'vouchers.vouchersCreated': 'تم إنشاء {0} كرت!',
    'vouchers.voucherReady': 'كرتك جاهز للاستخدام.',
    'vouchers.vouchersReady': 'كروتك جاهزة للاستخدام.',
    ...
    'security.warningBody': 'يبدو أن هذا الجهاز مكسور الحماية (روت/جيلبريك). قد يؤدي استخدام واصل على جهاز مخترق إلى تعريض حسابك وبيانات كروتك للخطر.',
    ...
    'notifications.title.voucher_quota_low': 'رصيد الكروت منخفض',
    'notifications.title.bulk_creation_complete': 'تم إنشاء الكروت',
    ...
    'notifications.body.voucher_quota_low': 'لقد استخدمت {0}% من حصة الكروت الشهرية.',
    'notifications.body.bulk_creation_complete': 'تم إنشاء {0} كرت لـ {1}.',

    // ── Extra Vouchers (detail / print / create wizard) ─────────────────────
    'vouchers.credentials': 'بيانات الاعتماد',
    'vouchers.voucherCode': 'رمز الكرت',
    ...
    'vouchers.enableVoucher': 'تفعيل الكرت',
    'vouchers.disableVoucher': 'تعطيل الكرت',
    'vouchers.shareVoucher': 'مشاركة الكرت',
    'vouchers.enableVoucherTitle': 'تفعيل الكرت؟',
    'vouchers.disableVoucherTitle': 'تعطيل الكرت؟',
    'vouchers.disableVoucherBody': 'سيمنع هذا استخدام الكرت للمصادقة.',
    'vouchers.enableVoucherBody': 'سيعيد تفعيل الكرت للمصادقة.',
    'vouchers.deleteVoucherTitle': 'حذف الكرت؟',
    'vouchers.deleteVoucherBody': 'هل أنت متأكد من حذف هذا الكرت؟ سيتم قطع الجلسات النشطة. لا يمكن التراجع عن هذا.',
    'vouchers.deletedSuccessfully': 'تم حذف الكرت بنجاح',
    'vouchers.credentialsCopied': 'تم نسخ بيانات الاعتماد',
    'vouchers.voucherNotFound': 'الكرت غير موجود',
    'vouchers.deleteSelectedCount': 'حذف ({0})',
    'vouchers.printSelectedCount': 'طباعة ({0})',
    'vouchers.deleteBody': 'حذف {0} كرت؟ سيتم قطع الجلسات النشطة. لا يمكن التراجع عن هذا.',
    'vouchers.deleteAllBody': 'حذف كل {0}{1} كرت؟ سيتم قطع الجلسات النشطة. لا يمكن التراجع عن هذا.',
    'vouchers.printVouchers': 'طباعة الكروت',
    'vouchers.goToVouchers': 'الذهاب إلى الكروت',
    'vouchers.columns': 'الأعمدة: {0}',
    'vouchers.readyToPrint': '{0} كرت جاهز للطباعة',
    ...
    'vouchers.validityOpen': 'مفتوح',
    'vouchers.timeLimitHint': 'إجمالي وقت الاتصال المسموح لهذا الكرت.',
    'vouchers.dataLimitHint': 'إجمالي البيانات المسموح بها لهذا الكرت.',
    'vouchers.voucherValidity': 'صلاحية الكرت',
    'vouchers.validityDescription': 'كم من الوقت بعد أول استخدام يجب أن يبقى الكرت صالحاً؟',
    'vouchers.custom': 'مخصص',
    'vouchers.openVoucher': 'كرت مفتوح',
    'vouchers.validityLabel': 'الصلاحية: {0}',
    'vouchers.openVoucherDesc': 'الكرت ليس له انتهاء زمني. سينتهي فقط عند استنفاد حد {0}.',
    'vouchers.validityVoucherDesc': 'سينتهي الكرت بعد {0} من أول تسجيل دخول، بغض النظر عن كمية {1} المتبقية.',
    'vouchers.onlineTime': 'وقت الاتصال',
    'vouchers.data': 'البيانات',
    'vouchers.time': 'الوقت',
    'vouchers.howMany': 'كم عدد الكروت؟',
    'vouchers.numberOfVouchers': 'عدد الكروت',
    'vouchers.pricePerVoucher': 'سعر الكرت',
    'vouchers.summary': 'الملخص',
    'vouchers.count': 'العدد',
    'vouchers.total': 'المجموع',
    'vouchers.each': '{0} لكل كرت',
    'vouchers.openNoExpiry': 'مفتوحة (بدون انتهاء)',
    'vouchers.createNVouchers': 'إنشاء {0} كرت',
    ...
    'subscription.noActiveSubscriptionDesc': 'اشترك في باقة لبدء إدارة الراوترات وإنشاء الكروت.',
    ...
    'subscription.voucherUsage': 'استخدام الكروت',
    ...
    'payment.transferInstructions': 'تعليمات التحويل',
    'payment.bankNotConfigured': 'اتصل بالمسؤول للحصول على تفاصيل البنك',
    'payment.includeReference': 'أضف الرقم المرجعي في التعليق.',
    ...
    'settings.contact': 'التواصل مع الدعم',
    'settings.contactSubtitle': 'أرسل رسالة إلى فريقنا',
    'contact.title': 'التواصل مع الدعم',
    'contact.empty': 'لا توجد رسائل بعد. أرسل لنا رسالة وسنرد هنا.',
    'contact.composerHint': 'اكتب رسالة...',
    ...
    'reports.voucherSales': 'مبيعات الكروت',
    ...
    'reports.totalVouchers': 'إجمالي الكروت',
    'reports.breakdownByProfile': 'التفصيل حسب الباقة',
    'reports.vouchers': 'كرت',

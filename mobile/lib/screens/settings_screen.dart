...
class _SettingsScreenState extends ConsumerState<SettingsScreen>
  ...
  Future<void> _handleLogout() async {
    final confirmed = await showConfirmDialog(
      context,
      title: context.tr('settings.logoutTitle'),
      message: context.tr('settings.logoutConfirm'),
      confirmLabel: context.tr('settings.logout'),
            ...
            children: [
              ...
              _SettingsTile(
                ...
                trailing: sub != null && sub.isActive
                    ? StatusBadge(
                        label: context.tr(
                            'settings.daysLeft', [sub.daysRemaining.toString()]),
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: AppSpacing.lg),
                child: SectionHeader(title: context.tr('settings.account')),
              ),
              _SettingsTile(
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: AppSpacing.lg),
                child: SectionHeader(title: context.tr('settings.appSection')),
              ),
              _SettingsTile(
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text(context.tr('settings.selectLanguage'),

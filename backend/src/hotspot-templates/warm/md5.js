/*
 * MikroTik RouterOS hotspot md5.js
 ...
 * This is the exact script MikroTik ships with the hotspot servlet; it
 * exposes hexMD5(string) used by login.html for CHAP authentication.
 */
...
/* Backwards compatibility - same as hexMD5() */
function calcMD5(s){ return binl2hex(coreMD5(str2binl(s), s.length * chrsz));}

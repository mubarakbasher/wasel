...
router.get('/history', authenticate, requireSubscription, validate({ params: routerIdParamSchema, query: sessionHistoryQuerySchema }), sessionController.getSessionHistory);
